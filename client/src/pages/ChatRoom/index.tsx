	...
	return (
		<ChatContainer>
			<div className="flex-container">
				...
				{userName === roomObj.roomId && <Button className="btn-delete" onClick={sendRemoveEvent}>Удалить комнату</Button>}
			</div>

			<Collapse style={{alignItems: 'center',width: '200px', position: 'absolute', right: 0}}>
				<CollapsePanel
					style={{
...
const ChatContainer = styled.div`
	...
	align-items: center;
	background: linear-gradient(to right, #102650, #5e3017); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
