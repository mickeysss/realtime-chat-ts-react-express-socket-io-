...
export function Auth({ onLogin, removedChat }: IAuth): React.ReactElement {
  ...
  const handleValidation = () => {
    ...
    if (!selectedRoom && newRoom.length < 3) {
      ...
      <FormContainer>
        <Form className="formContainer">
          ...
          <div>
            ...
            <Input type="text" placeholder="Введите логин" name="userName" onChange={(e) => handleChange(e)} />
          </div>
          <div>
            <Title
              style={{
          ...
          <Button onClick={(event) => handleSubmit(event)} size="large" type="ghost">
